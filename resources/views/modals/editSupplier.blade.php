<div class="modal fade" id="modaledSupplier" tabindex="-1" role="dialog" data-bs-backdrop="static" aria-labelledby="modalTitleId" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content border-0 p-2 px-3">
            <div class="d-flex justify-content-between border-bottom py-1">
                <span class="text-ed">Edit Data</span>
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="col d-flex justify-content-between ">
                            ...
                            <span type="number" class="text-error" id="ed-phoneNumber-error"></span>
                        </div>
